...
void ADCInit(void) 
{ 
   TRISEbits.RE2 = 1;                  //ADC channel 7 input    //Ref voltages Vdd & Vss; AN0 - AN7 channels Analog 
   ADCON1 = 0b00000111;                 //Right justified; Acquisition time 4T; Conversion clock Fosc/64     
   ADCON2 = 0b10101110;      
} 
